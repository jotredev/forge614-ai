...
- **Layout:** nodes stand 44 units from each other, so their circuits never overlap: Shell and Engram side by side and Engines below, centered, forming a triangle.
