...
- **Distribución:** los nodos quedan a 44 unidades entre sí, para que sus circuitos no se encimen: Shell y Engram lado a lado y Engines abajo, al centro, formando un triángulo.
