...
- **Conexiones:** la información viaja sola, sin nadie que la cargue: cables de fibra que salen de un conector y entran a otro, apoyados sobre las plataformas con clips metálicos y tensos en el aire entre ellas. Cada cable va en un solo sentido; si dos nodos se hablan en ambos sentidos, van dos cables juntos. Cada envío es un destello con estela que recorre el cable a velocidad pareja, y el conector que lo recibe se ilumina. Las relaciones salen de la tabla de contratos (sección 11 del contrato del ecosistema). Las primeras: Shell → Engram (guardar, azul) y Engram → Shell (devolver recuerdos, rosa).
- **Un solo reloj:** todo el mapa sigue el ritmo de la terminal de Shell, en el orden real. Shell escribe `forge614 prepare`, Engram busca y devuelve los recuerdos, Shell termina y guarda lo que hizo, Engram lo guarda y enseguida lo copia a la nube. Nada se mueve por su cuenta.
