...
| Código + pruebas con plan preciso | Sonnet · medium con parche o plan probado en laboratorio | **firme** (3 corridas Sonnet medium a la primera: Engram T7 con laboratorio, 0,63 M ≈ $0,39; T8 con parche por `git apply`, 0,42 M ≈ $0,27; T9b con parche, 0,31 M ≈ $0,23 en 4,1 min; cuarta: Reglamento 1.1.0 R1 con parche, 0,61 M ≈ $0,31 en 2 rondas, la segunda por error del plan, `dist/` ignorado; quinta: Engines E1 con parche desde forge614-shell, 0,32 M ≈ $0,23 en menos de 1 min, a la primera). Codex · medium: 1 corrida (Engram T2, 4,58 M tokens, 1 ronda por error del plan) |
...
| Documentación redactada por el agente a partir de datos verificados y lugares exactos | Sonnet · medium | **firme** (3 corridas, todas a la primera: Engram T4 docs, 1,08 M tokens ≈ $0,74; T7 docs, 1,43 M ≈ $0,68, atrapó un dato falso del plan; T8 docs + versión, 22 archivos, 1,36 M ≈ $0,76 en 3,1 min; cuarta: página de Notion de Engram 1.7.0 desde forge614-shell, 1,89 M ≈ $1,24 en 4 min, a la primera) |
