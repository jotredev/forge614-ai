...
| En un paso de publicación, «todos los checks en verde» nombra también las revisiones externas (CodeRabbit) y pide esperar a que ninguna quede pendiente antes de fusionar | provisional | Engram 1.7.2 T2 (Haiku 4.5): `gh pr checks --watch` terminó con los checks de CI en verde y CodeRabbit todavía procesando; fusionó 3 minutos después de abrir el PR |
